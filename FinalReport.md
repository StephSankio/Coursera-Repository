...
In order to keep this final report quite clear and clean, and to make reading more enjoyable, we divided the report in eight shorter notebooks so you can view the code and the comment to the issue.

In details, the following notebooks show the steps we took in order to reach these findings:
